...
@section('contenido')
    ...
    <form action="{{ route('producto.editar',$producto->id) }}" method="POST" class="form-action offset-4" role="form" id="product">
    @method('PUT')
    @csrf
    </div>
    ...
    <div class="form-group col-xs-6 col-sm-6 col-md-6 col-lg-6">
        ...
        <input type="text" class="form-control" id="" required name="nombre" placeholder="Nombre" value="{{$producto->nombre}}">
    </div>

    <div class="form-group col-xs-6 col-sm-6 col-md-6 col-lg-6">
        <label class="sr-only" for="">Descripcion</label>
        <input type="text" class="form-control" id="" required name="descripcion" placeholder="Descripcion"value="{{$producto->descripcion}}">
    </div>


    <div class="form-group col-xs-6 col-sm-6 col-md-6 col-lg-6">
        <label class="sr-only" for="">Imagen</label>
        <input type="text" class="form-control" id="" required name="imagen" placeholder="Url imagen"value="{{$producto->imagen}}">
    </div>
    ...
    <div class="form-group col-xs-6 col-sm-6 col-md-6 col-lg-6">
        ...
        <select name="categorias" id="categorias" form="product">
            ...
            @foreach ($categorias as $item)
                ...
                <option selected="selected" class="text-primary" value="{{ $item->id }}">{{ $item->nombre }}</option>
    ...
    <div class="form-group col-xs-6 col-sm-6 col-md-6 col-lg-6">
        ...
        <input type="number" class="form-control" id="" required name="cantidad" placeholder="Cantidad a agregar"value="{{$producto->cantidad}}">
    </div>

    <div class="form-group col-xs-6 col-sm-6 col-md-6 col-lg-6">
        <label class="sr-only" for="">precio</label>
        <input type="number" class="form-control" id="" required name="precio" placeholder="Precio en $"value="{{$producto->precio}}">
    </div>




    <button type="submit" class="btn btn-primary offset-2">Guardar cambios</button>
    </ul>
